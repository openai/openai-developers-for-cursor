...
6. For docs-only model selection, fetch `https://developers.openai.com/api/docs/guides/latest-model.md`; if it remains unavailable after one focused retry or official-domain fallback, state that the current model cannot be verified.
